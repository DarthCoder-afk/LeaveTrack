<?php 
include '../function/developers/developers_modal.php'; 
include '../database/db_connect.php'; // Adjust to your actual DB connection file

$logo_path = '../img/default.png'; // fallback logo path
$sql = "SELECT logo_path FROM settings LIMIT 1";
...
<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../pages/index.php" style="background-color: #2e8517;">
    <div class="sidebar-brand-icon">
      <img src="<?php echo $logo_path; ?>" style="border-radius: 50%;">
    </div>
